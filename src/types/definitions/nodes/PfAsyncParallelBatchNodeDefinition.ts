// src/types/definitions/nodes/PfAsyncParallelBatchNodeDefinition.ts
...
export class PfAsyncParallelBatchNodeDefinition extends AbstractNodeDefinition {
  constructor() {
    super({
      type: 'pf.AsyncParallelBatchNode',
      label: '异步并行批处理节点 (AsyncParallelBatchNode)',
      pocketflowClass: 'pf.AsyncParallelBatchNode',
      category: '核心',
      paramSchema: {
        name: { type: 'string', label: '名称', defaultValue: 'async_parallel_batch_node', required: true, description: '节点的唯一名称。' },
      ...
      defaultParams: {
        name: 'async_parallel_batch_node',
      ...
      description: 'PocketFlow 中的异步并行批处理节点。',
