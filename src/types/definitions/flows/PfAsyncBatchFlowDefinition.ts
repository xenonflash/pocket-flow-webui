// src/types/definitions/flows/PfAsyncBatchFlowDefinition.ts
...
export class PfAsyncBatchFlowDefinition extends AbstractFlowDefinition {
  constructor() {
    super({
      type: 'pf.AsyncBatchFlow',
      label: '异步批处理流程 (AsyncBatchFlow)',
      pocketflowClass: 'pf.AsyncBatchFlow',
      category: '流程控制',
      paramSchema: {
        name: { type: 'string', label: '名称', defaultValue: 'async_batch_flow', required: true, description: '流程的唯一名称。' },
      ...
      description: 'PocketFlow 中的异步批处理流程。',
